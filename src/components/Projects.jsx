...
const Projects = () => {
  return (
    <div className="border-b border-transparent pb-4">
      ...
      className="my-20 text-center text-4xl font-light">Projects</motion.h2>
      <div>
            ...
            <div key={index} className="mb-8 flex flex-wrap lg:justify-center">
              ...
              className="w-full max-w-xl lg:w-3/4">
                ...
                {project.technologies.map((tech, index) => (
                    <span key={index} className="mr-2 rounded bg-neutral-200 px-2 py-1 text-sm font-medium text-purple-950">
                        {tech}
                    </span>
                ))}
              </motion.div>  
